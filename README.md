...
Home Break is a lightweight, "invisible" surf alert system that runs in the background and texts you only when your spot is actually firing. It combines real data (NOAA buoys, Open-Meteo) with an AI personality engine to deliver alerts that feel like a text from a local buddy.
...
- AI message includes disclaimer: *"Buoy 42035 is offline, so we're flying blind on ground truth, but the models look solid."*

## Features

- **You Define the Vibe** - Set tiered triggers (e.g., "Lunch Break" = 2ft+, "Dawn Patrol" = 4ft+ offshore)
- **AI Personality** - Claude Haiku 4.5 transforms raw data into hyped, human-like messages
